...
#define PARM_FILEPATH archgraph/op/##PARM_NODE_CLASS##.parm.h
#endif

#define RTTR_NAME archlab::##PARM_NODE_NAME

rttr::registration::class_<archlab::node::PARM_NODE_CLASS>(XSTR(RTTR_NAME))
.constructor<>()

#define PARAM_INFO(id, type, name, member, default_val)        \
.property(#name, &archlab::node::##PARM_NODE_CLASS::member)       \
(                                                              \
