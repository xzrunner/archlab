...
public:
    ...
    static void UpdateModel(const std::vector<archgraph::GeoPtr>& geos,
...
private:
    static std::unique_ptr<model::Model>
        CreateBrushModel(const std::vector<archgraph::GeoPtr>& geos);
    static std::unique_ptr<model::Model>
        CreateModelFromFilepath(const std::vector<archgraph::GeoPtr>& geos);
