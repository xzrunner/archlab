...
WxEditorPanel::WxEditorPanel(wxWindow* parent, std::function<WxGraphPage*(wxWindow*)> graph_page_creator)
    : wxPanel(parent)
{
    InitLayout(graph_page_creator);
}

void WxEditorPanel::InitLayout(std::function<WxGraphPage*(wxWindow*)> graph_page_creator)
{
    ...
    prop->AddPage(m_graph_page = graph_page_creator(prop), "Graph");
